...
public class FactProfile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fact_profile);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                String name = dataSnapshot.child("factname").getValue().toString();
                String enroll=dataSnapshot.child("staffid").getValue().toString();
                String department = dataSnapshot.child("fdept").getValue().toString();
                String Email=dataSnapshot.child("factemail").getValue().toString();
                String phone=dataSnapshot.child("factmobno").getValue().toString();
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent ba=new Intent(FactProfile.this,FacultyHome.class);
                startActivity(ba);
            }
        });
    }
