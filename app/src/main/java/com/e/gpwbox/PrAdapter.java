...
public class PrAdapter extends RecyclerView.Adapter<PrAdapter.Prviewholder> implements Filterable {
    Context mContext;
    List<Message> mData;
    ...
    public PrAdapter(Context mContext, List<Message> mData) {
    ...
    public Prviewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new PrAdapter.Prviewholder(layout);
    }

    @Override
    public void onBindViewHolder(@NonNull Prviewholder holder, final int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent vm = new Intent(v.getContext(), Prview.class);
