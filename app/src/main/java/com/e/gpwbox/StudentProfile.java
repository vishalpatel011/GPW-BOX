    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                String enroll=dataSnapshot.child("enno").getValue().toString();
                String department = dataSnapshot.child("dept").getValue().toString();
                String Email=dataSnapshot.child("email").getValue().toString();
                String phone=dataSnapshot.child("mobileno").getValue().toString();
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent ba=new Intent(StudentProfile.this,Home.class);
                startActivity(ba);
            }
        });
    }
